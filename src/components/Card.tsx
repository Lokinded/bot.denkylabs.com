...
export default function Card(props: CardProps) {
  return (
    <div className="w-72 h-72 bg-[#1D1E28] border-4 border-solid border-purple-600 rounded-lg break-words ml-6 hover:bg-purple-600 transition-all duration-300 delay-100">
