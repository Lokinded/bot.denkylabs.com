...
export default function Spotify(data: Data | undefined) {
  ...
  return (
    <div className="mt-6 w-full">
      <h5 className="ml-1 mb-1 antialiased text-xs font-bold uppercase text-gray-400">{language.team.card.spotify}</h5>
      <div className="flex flex-row items-center rounded-lg overflow-hidden p-4 bg-[rgba(0,0,0,.2)]">
        ...
        <div>
          ...
          <span className="text-sm text-gray-300">
            {language.team.card.spotifyMusicAuthor} {data.spotify.artist.replaceAll('; ', ', ')}
          </span>
